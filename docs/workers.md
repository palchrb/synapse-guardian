...
| 8 | The callbacks themselves | **All** | R | See [`callbacks.md`](callbacks.md) | Each request is served by exactly one process, so exactly one decision | Yes | Nothing to do — this is the design |
